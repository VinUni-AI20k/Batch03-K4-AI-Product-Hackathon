...
5. Backend phân loại intent, chặn ngoài phạm vi/thiếu context, lấy evidence từ PDF, gọi model, kiểm citation và ghi trace.
6. Nếu backend/model lỗi, UI giữ câu hỏi và hiện lỗi; không tự rơi về mock.
