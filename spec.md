# AI SPEC — In-Action Learning Buddy · Nhóm [IllumiMATE] · Zone [D304]
...
**Evidence** — _"≥20 người ngoài nhóm · ≥50% xác nhận · log đầy đủ"_
Log: [`evidence/Hackathon Idea Survey_Submissions.csv`](evidence/Hackathon%20Idea%20Survey_Submissions.csv) (n=39 ≥ 20 ✓, log đầy đủ từng câu hỏi + từng câu trả lời có trong file ✓ — đã đối chiếu lại toàn bộ 39 dòng, mọi % trong bảng dưới khớp chính xác với dữ liệu thô)

- **Số liệu khảo sát (n=39, % xác nhận)**:
  | Câu hỏi | Kết quả |
  |---|---|
...
**Bảng impact ≥3 ứng viên** _(bao nhiêu người · tần suất · tốn gì mỗi lần · khả thi)_ — n=39 khảo sát:

| Ứng viên                                                                              | Bao nhiêu người gặp (n=39)                                                                                                                                            | Tần suất                     | Tốn gì mỗi lần                                            | Khả thi (1 ngày)                                        |
| ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | --------------------------------------------------------- | ------------------------------------------------------- |
...
| Tự làm flashcard (Anki/Quizlet)                                                       | Suy luận từ problem-definition.md                                                                                                                                     | Không đều, tốn công setup    | ~20-30 phút làm thủ công/buổi                             | Thấp — không adaptive                                   |
...
- _Đọc lại toàn bộ slide_: không cá nhân hóa, không kiểm chứng được mức hiểu, tốn thời gian nhất trong khi đây là persona "quỹ thời gian giới hạn" (51% chỉ muốn ôn 10-30 phút).
- _Flashcard thủ công_: không adaptive theo lỗ hổng thực tế, effort bỏ ra không tương xứng giá trị nhận lại.
- _Quiz cuối chương có sẵn (nếu khóa học có)_: dừng ở bước kiểm tra, không đóng vòng lặp dạy lại — đây chính là khoảng trống hướng B nhắm tới.
- _Hỏi chatbot chung chung_: 29% xác nhận "không bám sát ngữ cảnh bài giảng", 14% xác nhận rủi ro bịa sai — persona nói rõ "họ đã có ChatGPT cho việc đó", không cần build lại việc này.
...
4 thành viên mỗi người tự dùng thử 15 phút để có nhiều góc nhìn:

| Người    | Sản phẩm thử                                                | ① Flow giải job                                                            | ② Đáng học (quan sát cụ thể)                                                                                        | ③ Đáng né                                                                               | ④ Mình khác gì                                                                                                                                                                                                                                                                                                                               |
| -------- | ----------------------------------------------------------- | -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Đạt      | Quizlet AI / Duolingo (cơ chế đo mức hiểu qua câu hỏi)      | Upload tài liệu ➔ Auto gen flashcard ➔ Làm test trắc nghiệm ➔ Xem điểm.    | Thanh tiến trình (progress bar) trực quan, có hiệu ứng ăn mừng nhỏ giúp giữ động lực học.                           | Chỉ test được trí nhớ (thuộc lòng), câu hỏi AI gen ra đôi khi bị ngô nghê.              | Điểm số dừng lại ở "bao nhiêu câu đúng" — không nói được vì sao sai/sai ở đâu trong bài giảng. Sản phẩm mình không chốt ở điểm số: câu sai trỏ thẳng về section trong outline và đoạn transcript gốc, biến kết quả quiz thành đầu vào cho bước dạy lại, không phải điểm cuối cùng để "ăn mừng" rồi thôi.                                     |
| Linh     | NotebookLM (Q&A có trích dẫn nguồn tài liệu)                | Upload PDF ➔ Đọc tóm tắt ➔ Gõ prompt hỏi ➔ Đọc câu trả lời kèm trích dẫn.  | Click vào trích dẫn (citation) số nhỏ ➔ Highlight thẳng đoạn văn bản tương ứng ở file gốc bên trái. Rất uy tín.     | UI quá nhiều chữ (wall of text). User không biết hỏi gì thì ứng dụng "nằm im" thụ động. | Giữ đúng cơ chế trích dẫn nhảy-về-nguồn này cho Study Note (đã cam kết ở §4b G11/PAIR Explainability) — nhưng không chờ user tự gõ câu hỏi vào ô chat trống: hệ thống chủ động chạy quiz chẩn đoán trước, biết sẵn user yếu section nào rồi mới chủ động sinh nội dung, thay vì để user tự đoán "mình nên hỏi gì".                           |
| Anh Tuấn | Khanmigo (giao diện trợ lý học tập chủ động hỏi ngược)      | Bật chat ➔ Chọn môn ➔ Trợ lý đặt câu hỏi mớm lời ➔ User trả lời từng bước. | Không đưa đáp án ngay mà mớm (hint) từng chút một. Icon avatar nhấp nháy khi đang gen text tạo cảm giác thân thiện. | Flow setup ban đầu rườm rà, phải chọn nhiều thông tin cá nhân/cấp học.                  | Không đi theo lối Socratic hỏi-đáp kéo dài từng bước — quỹ thời gian của user là 10-30 phút sau giờ học (51% khảo sát), không phải một buổi kèm riêng. Mình bỏ hẳn bước setup cấp học/môn học vì context đã có sẵn 100% từ slide+transcript đúng buổi học vừa upload, không cần hỏi lại user là ai.                                          |
| Mai Anh  | ChatGPT Study Mode / Claude (baseline "hỏi AI chung chung") | Mở app ➔ Chọn voice mode / gõ prompt ➔ Nhận giải thích ➔ Trò chuyện tiếp.  | Tốc độ phản hồi giọng nói (Voice Mode) cực mượt, ngắt lời được AI mọi lúc.                                          | Phải tự viết prompt mồi rất dài để AI đóng vai "người khảo bài" chuẩn ý.                | Vai "người khảo bài" ở đây không cần user tự mồi prompt — quiz chẩn đoán + weakness detection làm sẵn việc đó tự động. Và câu trả lời luôn bám 100% transcript của đúng buổi học thật, không phải kiến thức chung của AI (voice mode mượt là điểm hay nhưng nằm ngoài phạm vi MVP — xem §4 non-goal #2, dùng dropdown thay hội thoại tự do). |

**Điểm khác biệt đã xác nhận sau khi dùng thử thật**: cả 4 sản phẩm đều rơi vào một trong hai cực — hoặc đo/hỏi xong rồi dừng lại ở kết quả (Quizlet/Duolingo: điểm số; ChatGPT: user phải tự mồi prompt), hoặc chủ động dẫn dắt nhưng tốn thời gian/setup (Khanmigo: hỏi-đáp Socratic từng bước, phải chọn cấp học/môn trước), hoặc có trích dẫn đáng tin nhưng bị động chờ user hỏi (NotebookLM). Khảo sát (n=39) cho thấy 49% hào hứng nhất với "chủ động gợi mở, đặt câu hỏi ngược lại" và 51% ưu tiên ôn 10-30 phút — sản phẩm này đứng ở giữa: chủ động như Khanmigo (tự chẩn đoán, không chờ user hỏi) nhưng nhanh gọn như đọc tóm tắt (không hỏi-đáp từng bước), và giữ cơ chế trích dẫn uy tín của NotebookLM để mọi khẳng định đều trace được về đúng buổi học thật.
...
- Lý do theo cost-of-error: rewrite sai lệch với bài giảng gốc (hallucination) có cost-of-error cao trong bối cảnh học tập — học sai kiến thức từ nội dung tưởng là "dạy lại đúng bài giảng" nguy hiểm hơn không có công cụ. Khảo sát (n=39) xác nhận đây không phải rủi ro lý thuyết: **14%** người dùng từng gặp "AI tự tin nhưng bịa sai kiến thức" khi tự học bằng ChatGPT/Claude — đây chính là điều sản phẩm phải tránh lặp lại. Vì vậy giữ user-in-loop toàn bộ: mọi câu trong Study Note phải trace được về nguồn, retest cho user tự đối chiếu thay vì hệ thống tự phán "bạn đã hiểu/chưa hiểu". Không tự động hoá quyết định "học viên đã sẵn sàng qua bài tiếp theo".

**§4b. Nguyên tắc đã áp dụng** :

| Mã                               | Nguyên tắc                                     | Áp cụ thể vào đâu trong prototype                                                                                                                                                                                                                                                     |
| -------------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **G1** _(khởi đầu)_              | Làm rõ hệ thống làm được gì                    | Trước khi bắt đầu quiz, hệ thống nói rõ 1 câu phạm vi: "Mình chỉ trả lời dựa trên slide + transcript buổi học bạn vừa tải lên — không phải kiến thức chung." Không mở đầu bằng đoạn văn dài (guide chỉ trích đúng lỗi này: "tutor chào bằng cả đoạn văn — có ai đọc?")                |
| **G2** _(khởi đầu)_              | Làm rõ nó làm tốt đến đâu                      | Mỗi section trong Study Note có "mức độ tự tin" (confidence indicator) thay vì khẳng định chắc nịch — user biết khi nào nên tin, khi nào nên tự kiểm lại với giảng viên/TA                                                                                                            |
| **G10** _(bắt buộc)_             | Thu hẹp phạm vi khi nghi ngờ                   | Weakness analysis không chắc chắn (câu hỏi mở mơ hồ/bỏ trống) → không khẳng định "bạn yếu phần X", chỉ dựa vào pattern sai của quiz và gắn nhãn confidence thấp; alignment không tìm được đoạn nguồn khớp → báo "không tìm thấy căn cứ trong bài giảng này" thay vì bịa (xem §5, §6①) |
...
| **G8** _(cân nhắc thêm nếu kịp)_ | Gạt bỏ dễ dàng                                 | User có thể bỏ qua gợi ý "nên đọc lại section này", tự chuyển sang section khác hoặc thoát quiz retest bất kỳ lúc nào — không bị ép theo đúng thứ tự hệ thống đưa ra                                                                                                                  |

**PAIR áp dụng thêm**:

- **Explainability + Trust**: mục tiêu là _tin đúng mức_, không phải _tin tối đa_ — mọi câu trong Study Note hiển thị căn cứ cạnh câu, không giấu ở link riêng, để user tự kiểm được ngay tại chỗ.
...
_(4 lớp theo guide §2.5: ① nguồn sự thật — chỗ AI bịa được · ② mơ hồ/thiếu thông tin · ③ ngoài phạm vi/thẩm quyền · ④ đặc thù domain — sai gì thì học sai kiến thức/mất điểm/mất niềm tin ngay. Mỗi lớp ≥2 case, tổng ≥8.)_
...
- **Correction (user sửa)**: User đọc Study Note, thấy đoạn không khớp với những gì giảng viên thực sự nói (do alignment sai) → cần cơ chế feedback nhanh (flag) ngay tại đoạn đó
...
**Golden set (gồm 25 cases, file trong `eval/`)** — cơ cấu theo guide §2.6:
...
| Người                              | Task sở hữu                                                                                                               |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| Hà Anh Tuấn - 2A202601582          | (1) Extract Outline · (3) Knowledge Package                                                                               |
| Nguyễn Minh Đạt - 2A202601142      | (2) Initial Quiz · (9) Retest Quiz                                                                                        |
| Nguyễn Thị Hương Trà - 2A202601416 | (4) Quiz UI + Rule-based Grading · (6) UI style/time (độc lập, chèn bất cứ lúc nào) · (10) Retest Grading + Result screen |
| Đoàn Ngọc Linh - 2A202601762       | (5) Learning Diagnosis (weak_sections + quyết định reteach/retest) · (7) Align weak sections ↔ transcript                 |
| Trần Hoàng Mai Anh - 2A202601324   | (8) Alignment + Rewrite với grounded content                                                                              |

**Willing users (≥3 tên) + kế hoạch vòng validation CP5**:

# Phỏng vấn người dùng – Study Note

| Người dùng            | Feedback chính                                                                  | Ưu tiên    |
| --------------------- | ------------------------------------------------------------------------------- | ---------- |
| **Nguyễn Hải Yến**    | Không thể tải lên tệp ngoài định dạng PDF.                                      | Cao        |
| **Nguyễn Phương Hoa** | AI tạo quiz hơi lâu, làm gián đoạn trải nghiệm.                                 | Cao        |
| **Trần Hương Giang**  | Bài giảng chưa đủ cá nhân hóa theo nhu cầu và năng lực.                         | Trung bình |
| **Phạm Thành Đạt**    | Số lần retest quiz còn ít, chưa đủ để theo dõi tiến bộ.                         | Trung bình |
| **Phạm Quang Hưng**   | Thời gian chờ quiz phân tích năng lực khá lâu; bài giảng cũng chưa đủ chi tiết. | Cao        |
| **Phạm Huyền Thanh**  | Chưa thấy ứng dụng có điểm gì thực sự ấn tượng.                                 | Trung bình |
| **Hoàng Thu Hà**      | Active Mode chưa tạo khác biệt rõ ràng so với trải nghiệm thông thường.         | Cao        |
...
| ------------ | ----------------------------------------------------------------------------------------------------- | --------------------------------- |
| 22:12 [30/7] | Bản đầu tiên, chưa có evidence thật                                                                   |
| 7:00 [31/7]  | Bổ sung evidence từ khảo sát n=39 vào §1, §2                                                          | Có file CSV khảo sát thật         |
| 12:00 [31/7] | Chỉnh §3, §4b, §5, §7 khớp đúng thuật ngữ/cấu trúc guide (G-code HAX, 4 lớp chuẩn, cơ cấu golden set) | Nhận được file guide chính thức   |
