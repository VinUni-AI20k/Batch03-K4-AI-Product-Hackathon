...
- Thời điểm UTC: 2026-07-30T18:02:14.166112+00:00
- Pipeline: `codebase/agent_core.py` (cùng pipeline với UI)
- Pre-score theo khái niệm: **23/24 = 96%**
- Pre-score khớp đúng nhãn chữ: **22/24 = 92%**

### Tách theo bên ra quyết định

- **Case do AI quyết định: 17/18 = 94%** — đây là con số phản ánh năng lực thật của model.
...
- Citation đối chiếu được với text thật của trang: **44/52 = 85%**
...
| GS-04 | normal | AI | answered | ĐẠT | 5/5 | đạt pre-score |
| GS-05 | normal | AI | answered | ĐẠT | 1/1 | đạt pre-score |
| GS-06 | normal | AI | answered | ĐẠT | 1/1 | đạt pre-score |
| GS-07 | normal | AI | answered | ĐẠT | 3/3 | đạt pre-score |
| GS-08 | normal | AI | answered | ĐẠT | 2/2 | đạt pre-score |
...
| GS-17 | rare | AI | answered | ĐẠT | 5/8 | đạt pre-score |
| GS-18 | rare | AI | answered | ĐẠT | 2/2 | đạt pre-score |
| GS-19 | rare | AI | answered | ĐẠT | 0/2 | đạt pre-score |
| GS-20 | rare | AI | answered | ĐẠT | 4/7 | đạt pre-score |
