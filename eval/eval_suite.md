...
- source_detail: CSV `Hackathon Idea Survey_Submissions.csv`, Respondent ID `pb94JEE`, cột “Điều gì khiến bạn NẢN NHẤT khi dùng ChatGPT hay Claude để học bài?” — quote nguyên văn: “AI trả lời một tràng văn bản dài dằng dặc, đọc mệt hơn cả đọc Slide.”
...
- category: 1
- source: real_observed
- source_detail: CSV `Hackathon Idea Survey_Submissions.csv`, Respondent ID `815jRx5`, cột “Điều gì khiến bạn NẢN NHẤT khi dùng ChatGPT hay Claude để học bài?” — quote nguyên văn: “Thỉnh thoảng AI nói rất tự tin nhưng lại bịa sai kiến thức.”
...
- category: 1
- source: real_observed
- source_detail: CSV `Hackathon Idea Survey_Submissions.csv`, Respondent ID `LZy5ojG`, cột “Điều gì khiến bạn NẢN NHẤT khi dùng ChatGPT hay Claude để học bài?” — quote nguyên văn: “AI giải thích chung chung kiến thức trên mạng, không bám sát tinh thần/ngữ cảnh bài giảng của lớp.”
...
- category: 1
- source: real_observed
- source_detail: CSV `Hackathon Idea Survey_Submissions.csv`, Respondent ID `ja2GYL1`, cột “Điều gì khiến bạn NẢN NHẤT khi dùng ChatGPT hay Claude để học bài?” — quote nguyên văn: “Thỉnh thoảng AI nói rất tự tin nhưng lại bịa sai kiến thức.”
...
- category: 1
- source: real_observed
- source_detail: CSV `Hackathon Idea Survey_Submissions.csv`, Respondent ID `A75WZAk`, cột “Điều gì khiến bạn NẢN NHẤT khi dùng ChatGPT hay Claude để học bài?” — quote nguyên văn: “AI giải thích chung chung kiến thức trên mạng, không bám sát tinh thần/ngữ cảnh bài giảng của lớp.”
...
- category: 2
- source: real_observed
- source_detail: Respondent ID: teammate-provided; teammate_observed_run: Một thành viên bôi đen một đoạn trong slide demo về “học sâu”, hỏi “học tăng cường là gì?”, rồi dán nguyên văn đoạn chọn, câu hỏi và output thực tế của sản phẩm.
...
- category: 2
- source: real_observed
- source_detail: Respondent ID: teammate-provided; teammate_observed_run: Thành viên bôi đen một paragraph ngẫu nhiên trong slide demo và hỏi một chủ đề không liên quan; ghi lại input/output thực tế để thay placeholder.
...
- category: 2
- source: real_observed
- source_detail: Respondent ID: teammate-provided; teammate_observed_run: Chạy dry-run highlight-to-ask trên slide với câu hỏi lệch chủ đề, lưu nguyên văn đoạn chọn, câu hỏi và output; không thay bằng quote giả.
...
- category: 3
- source: real_observed
- source_detail: Respondent ID: teammate-provided; teammate_observed_run: Dán một bộ quiz response thật từ dry-run sản phẩm, trong đó trường “phần nào khó nhất” bị bỏ trống; kèm transcript/outline và output chẩn đoán thật.
...
- category: 3
- source: real_observed
- source_detail: Respondent ID: teammate-provided; teammate_observed_run: Chạy quiz với câu “phần nào khó nhất” mâu thuẫn với pattern điểm, lưu nguyên văn answer set và diagnosis để thay placeholder.
...
- category: 3
- source: real_observed
- source_detail: Respondent ID: teammate-provided; teammate_observed_run: Chạy dry-run với câu trả lời “phần nào khó nhất” lạc đề, lưu câu chữ trong test và output diagnosis; không tự thay bằng chatlog giả.
...
- category: 4
- source: real_observed
- source_detail: Respondent ID: teammate-provided; teammate_observed_run: Dán nguyên văn một quote CSV về transcript/chat có filler, code-switching hoặc input lộn xộn, kèm respondent ID hoặc số dòng.
...
- category: 4
- source: real_observed
- source_detail: Respondent ID: teammate-provided; teammate_observed_run: Dán nguyên văn một quote CSV về câu trả lời ngắn/slang hoặc transcript messy, kèm respondent ID hoặc số dòng.
...
TARGET_PASS_RATE: \_\_% <- team commits to this BEFORE running eval, does not lower it after seeing results
...
- Input placeholder còn lại: 0; 8 case category 2–4 đã được xác nhận bằng kết quả teammate-provided.
- Đã thay 5 placeholder CSV bằng quote nguyên văn có Respondent ID từ `Hackathon Idea Survey_Submissions.csv`; không có quote khảo sát nào bị giả mạo.
