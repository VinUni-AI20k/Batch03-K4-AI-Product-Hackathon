    ...
    def complete(
        ...
        *,
        ...
        kwargs: dict[str, Any] = {
            ...
            # Keep OpenRouter/OpenAI requests affordable and avoid providers
            # reserving the model's very large default output window.
            "max_tokens": max(256, int(os.getenv("MODEL_MAX_TOKENS", "4096"))),
        }
        if tools:
            kwargs["tools"] = tools
