...
from .ask_for_missing_info.tool import ask_for_missing_info
from .citation_audit.tool import audit_citations
from .confirm_action.tool import confirm_action
...
from .search_social_topic.tool import search_social_topic
...
TOOL_FUNCTIONS = {
    ...
    "search_social_topic": search_social_topic,
    "lookup": web_search,
    "fetch": read_url,
