...
**Willing users dự kiến (≥3):**

| Tên | Vai | Đã hỏi chưa |
|---|---|---|
| Nguyễn Văn Trọng | học viên khoá | chưa |
...
**Thành viên:** `2A202601256` — Nguyễn Hùng Mạnh

| Người | Phần |
|---|---|
| Nguyễn Hùng Mạnh | spec.md · vòng validation CP5 |
| Nguyễn Hùng Mạnh | evidence · golden set từ chatlog thật |
| Nguyễn Hùng Mạnh | prompt · chạy đo golden set |
| Nguyễn Hùng Mạnh | code flow · demo |
