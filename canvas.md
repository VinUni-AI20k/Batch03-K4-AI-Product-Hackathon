...
| 7 | **Phân công có tên** | **Trần Đại Nghĩa — Product Lead & Core LLM Owner:** Canvas, JTBD, scope, spec, chọn model, system prompt, output contract và demo script.<br>**Phó Hiếu Anh — Data & Evidence:** mining chatlog, khảo sát, data normalizer, lọc theo `day_code`/conversation và source manifest.<br>**Nguyễn Xuân Đức — AI Evaluation:** signal taxonomy, golden set, quality bar, eval report và review prompt/schema.<br>**Trần Tuấn Anh — Backend/Integration:** API route, gọi model theo contract, grounding runtime, JSON/citation validator và error handling.<br>**Hoàng Trọng Đại — UX/Frontend & Validation:** note/mindmap UI, adapter từ API sang view, bốn đường trải nghiệm, user test và feedback log. |
