...
**Bộ log này đạt cả hai điều kiện của R6.** Ghi lại đây để nhóm nắm rõ và trả lời được nếu TA hỏi:

- **≥5 người ngoài nhóm, có tên, quote nguyên văn** — 5/5 đủ.
- **≥2 willing user đã khai từ CP1** — Lưu Xuân Dũng và Trần Thê Ninh, đã đánh dấu trong bảng.
- **≥1 thay đổi từ feedback ghi trong Changelog** — 2 thay đổi thật đã sửa và đo lại (xem mục Thay đổi ở trên), cộng 2 quyết định giữ nguyên có lý do căn cứ.

**Một điểm nhóm nên chủ động nói:** mỗi phiên ~3 phút, ngắn hơn mức 10 phút/người mà guide §4.2 gợi ý. Điều này có ảnh hưởng thật đến chiều sâu — trong 3 phút người thử kịp gõ yêu cầu, đọc kết quả và nêu nhận xét, nhưng không kịp thử nhiều luồng khác nhau (upload CV, duyệt kho đề tài, đổi ràng buộc nhiều lần). Nên phần lớn feedback tập trung vào ấn tượng đầu về giá trị sản phẩm, chứ không phải về các luồng sâu bên trong. Đây cũng là lý do bảng quan sát không có số lần bấm hay đường đi chuột chi tiết.

Điều đó **không làm giảm giá trị của phát hiện chính** — ngược lại, việc 4/5 người chỉ cần 3 phút đã đủ kết luận "chưa cần thiết" chính là bằng chứng mạnh rằng vấn đề nằm ở tính thuyết phục ngay từ ấn tượng đầu, không phải ở chỗ họ chưa kịp khám phá hết tính năng.
