...
**1. Cột "Quan sát" có phần hành vi nhưng thiếu phần định lượng.** Rút được từ lời người thử: họ gõ gì vào chat, đã xem kết quả chưa, kẹt ở bước nào, và kẹt vì thao tác hay vì thiếu thông tin để quyết định. Cụ thể: **4/5 người không kẹt ở thao tác nào** — Thùy phản ứng ở mức khái niệm trước cả khi dùng; Ninh và Linh đều nhận được kết quả rồi mới kết luận tiêu cực; Trang đọc hết 3 đề rồi mới kẹt. Chỉ Dũng gặp lỗi chức năng thật, và lỗi đó đã tái hiện được (2/3 lần) rồi sửa.

Thứ **không** có: thời lượng mỗi phiên, số lần bấm, họ dừng lại bao lâu ở màn hình nào — guide §4.2 yêu cầu "mất bao lâu để ra kết quả đầu tiên", phần này chưa ai bấm giờ và không suy ra được từ quote. Nếu còn liên hệ được 5 người trên, bổ sung phần định lượng sẽ làm bộ log mạnh hơn.
