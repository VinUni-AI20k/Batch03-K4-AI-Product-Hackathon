---
course: AI20K
generated: '2026-07-30T17:37:53+00:00'
lang: vi
lesson: 2-02-deliverable-example
maps:
- '[[MOC - AI20K]]'
module: ''
source_file: AI20K/2-02-deliverable-example.pdf
source_hash: sha256:108a592cfe4575cbc9a9b7e95c05dba16c0071447b55156677c424eef0a32c9b
type: lesson-note
---

## Slide 1 — Ví dụ bản nộp - Weekly Report trước và sau AI

Ví dụ này cho thấy một bài nộp Day 02 hoàn chỉnh. Hãy học cách đi từ [[problem-scan]] → [[workflow]] → [[research]] → [[problem-statement]] → [[rule-workflow-agent]] → quyết định cuối.

## Slide 2 — Case ví dụ: Tổng hợp weekly report
...
## Slide 3 — Vì sao đây là ví dụ tốt?

- Có actor cụ thể.
- Có [[workflow]] lặp lại hàng tuần.
- Có [[bottleneck]] rõ.
- Có [[metric]] thời gian.
- Có thể so sánh [[Rule]] / [[Workflow]] / [[Agent]].
- Có thể vẽ before/after workflow.

## Slide 4 — Individual Problem Scan
...
## Slide 6 — Problem Card #1 - Weekly Report
...
Thứ Hai hàng tuần, trước buổi leadership sync.
...
## Slide 7 — Draft current workflow

<!-- image -->

## Slide 8 — Draft future workflow

<!-- image -->

## Slide 9 — Problem Cards #2 và #3 - tóm tắt

| Card         | Actor       | Bottleneck                         | Metric                  | Phán đoán ban đầu   | Vì sao chưa chọn làm #1   |
|--------------|-------------|------------------------------------|-------------------------|-----------------------|-------------------------------|
| Review PRD   | PM reviewer | Đọc 10-15 trang để hiểu context | 45 phút → 20 phút       | [[Workflow]]              | Quality metric khó thống nhất trong thời gian lab      |
| Slack Search | Team member | Search keyword rồi đọc thread   | 15 phút → dưới 2 phút | Agent / [[Workflow]]      | Data access và scope rộng   |

## Slide 10 — Group Problem Statement

### Group convergence

Nhóm 3-4 người, mỗi người trình bày top 3. Tổng cộng khoảng 9-12 candidates.
...
| [[Planning]] / follow-up           | Action item tracking, deadline reminder                | Sau cuộc họp/lab có nhiều việc bị rời rạc                               |

## Slide 11 — Shortlist và score
...
## Slide 13 — Insight sau validation:
...
## Slide 14 — Research giải pháp

Nhóm tìm các hướng đã có sẵn, không giả định phải tự build từ đầu.

| Nguồn / tool / case   | Link                                                              | Học giải quyết phần nào?         | Điểm mạnh                  | Khoảng trống / rủi ro                                   | Bài học              |
|-------------------------|-------------------------------------------------------------------|----------------------------------------|---------------------------------|---------------------------------------------------------------|----------------------|
| Atlassian Jira Reports  | https://www.atlassian.com/software/jira/features/reports          | Dashboard/report từ Jira data         | Tốt cho số liệu structured | Không tự viết business narrative theo context Slack/Sheets | Rule đủ số , nar     |
| [[Slack]] AI                | https://slack.com/help/articles/25076892548883-Guide-to-Slack-AI | Summary/search trong Slack             | Tốt cho recap conversation    | Chỉ là một nguồn, không gom toàn bộ Jira/Sheets/Docs    | Có nhiều kênh làm tốt   |
| Gemini in Drive         | https://support.google.com/drive/answer/15141241                  | Update/summarize nội dung file       | Tốt cho tóm tắt tài liệu  | Cần kiểm nguồn, không nên tự gửi output              | AI ng rev            |
| Fellow AI Meeting Notes | https://fellow.ai/features/ai                                     | Meeting notes, action items, summaries | Tốt cho recap có cấu trúc   | Không trực tiếp giải bài toán Jira/Sheets weekly report | Pat dra th           |

## Slide 15 — Research takeaway:

Không nên build một [[agent]] tự chạy toàn bộ báo cáo ngay. Hướng hợp lý hơn là [[workflow]]: tự động lấy / cấu trúc dữ liệu ở các bước rõ, dùng AI hỗ trợ phần narrative.

## Slide 16 — Workflow before/after
...
| Rủi ro mới         | Không có AI hallucination | Có hallucination risk | Cần review trước khi gửi                             |

## Slide 18 — Problem Statement v0
...
| Boundary       | Không tự gửi report; không tự bị a insight; không thay PM quyết định nội dung cuối; chỉ dùng data được cung cấp.         |

## Slide 19 — Rule / Workflow / Agent
...
| [[Workflow]]      | Script lấy data → AI cấu trúc → AI draft narrative → PM review   | Hợp vì workflow tuyên tính, AI chỉ hỗ trợ vài bước ngôn ngữ        | Draft sai/nhạt, cần PM review                     | Chọn                                                        |
...
| Boundary                             | AI không tự gửi report, không tự bị a số liệu, không thay PM approve.                                                         |
...
## Slide 22 — Final decision

### Decision:

Đi với scope nhỏ.

## Slide 23 — Pilot nhỏ nhất:
...
## Slide 24 — Exit / rollback:

- Nếu PM vẫn phải viết lại hơn 70% draft trong 2 tuần liên tiếp, hạ xuống template + dashboard.
- Nếu AI bị a số liệu hoặc trích sai nguồn, không cho dùng trực tiếp trong report.

## Slide 25 — Decision rationale:
...
## Slide 26 — Individual Reflection Example
...
| Challenge               | Hỏi nhóm [[Slack]] [[Search]] có data access không               | Nhóm lo lắng bớt scope quá rộng               |
...
## Slide 27 — Bảng dùng AI trong reflection

| Phase             | Tôi dùng AI để làm gì?                | AI hữu ích ở đâu?                    | AI sai/nhạt ở đâu?                       | Tôi sửa gì                                                         |
|-------------------|---------------------------------------|-----------------------------------------|--------------------------------------------------|----------------------------------------------------------------------|
...
| [[Problem Statement]] | Nhờ AI phản biệt field mơ hồ   | Chỉ ra metric quality yếu            | AI đề xuất [[agent]] quá sớm                     | Nhóm hạ về [[Workflow]]                                                |

## Slide 28 — Bài học của Minh
...
- [[problem-scan]]: Quá trình xác định và ghi nhận các vấn đề cụ thể trong workflow.
- [[workflow]]: Quy trình làm việc mà các tác nhân thực hiện để hoàn thành nhiệm vụ.
- [[bottleneck]]: Bước trong quy trình gây ra sự chậm trễ hoặc tăng thời gian hoàn thành.
- [[metric]]: Thước đo để đánh giá hiệu suất hoặc tiến độ của quy trình.
- [[Rule]]: Quy tắc nhất định được áp dụng trong workflow.
- [[Agent]]: Hệ thống tự động thực hiện các nhiệm vụ mà không cần sự can thiệp của con người.
- [[Product Manager]]: Người quản lý sản phẩm, đại diện cho lợi ích của khách hàng và các bên liên quan trong quá trình phát triển sản phẩm. 
- [[SaaS]]: Phần mềm dưới dạng dịch vụ, cho phép người dùng truy cập và sử dụng phần mềm qua internet.
