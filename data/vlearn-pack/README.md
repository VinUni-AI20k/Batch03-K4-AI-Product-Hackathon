...
- `slides/` — **2 bộ slide bài giảng bản hackathon** (Day 1 AI & LLM Foundation · Day 2 Xác định bài toán cho AI, 29 trang/bộ, có watermark): bản rút gọn từ slide gốc, một số trang giữ nguyên footer số trang gốc. Tra theo số trang PDF trong [chỉ mục trích dẫn đầy đủ](slides/CITATION_INDEX.md), hoặc mở nhanh phần [Day 1](slides/CITATION_INDEX.md#day-1) và [Day 2](slides/CITATION_INDEX.md#day-2).
