...
# TASK
Classify EVERY segment listed below into exactly one of three labels. There are
multiple segments in this request — you MUST return one entry per segment, in
any order, none skipped.
...
# INPUT FORMAT
Each line is one segment: [T-xxx] Content of the segment.

# OUTPUT FORMAT
Output STRICTLY a single JSON array, one object per input segment, each with:
- segment_id: The ID of the segment (e.g., "T01-001").
- label: One of "TEACHING_CONTENT", "CLASSROOM_ACTIVITY", or "OFF_TOPIC".

Example output for 2 segments:
[{{"segment_id": "T01-001", "label": "TEACHING_CONTENT"}}, {{"segment_id": "T01-009", "label": "CLASSROOM_ACTIVITY"}}]
