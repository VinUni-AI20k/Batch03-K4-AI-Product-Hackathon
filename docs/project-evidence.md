...
- Artifact: [`../evidence/cp4-survey/`](../evidence/cp4-survey/) gồm câu hỏi, 45 hàng dữ liệu, bảng đếm, biểu đồ, hash ZIP nguồn và script tái lập.
...
- Artifact: [`../evidence/cp4-log-mining/`](../evidence/cp4-log-mining/) gồm quy tắc lọc/đếm, log JSONL, hash nguồn, script tái lập và 8 ví dụ đã khử định danh.
...
| Dữ liệu khảo sát khử định danh | [`../evidence/cp4-survey/responses-deidentified.csv`](../evidence/cp4-survey/responses-deidentified.csv) |
| Kết quả tổng hợp khảo sát | [`../evidence/cp4-survey/aggregate-results.csv`](../evidence/cp4-survey/aggregate-results.csv) |
| Log quan sát đã khử định danh | [`../evidence/cp4-log-mining/observed-log.jsonl`](../evidence/cp4-log-mining/observed-log.jsonl) |
